...
export default function NotificationDropdown() {
  ...
  //     try {
  //       const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/stream-notif`);
  ...
  //         // Nyalakan titik lampu jika ada minimal 1 notifikasi di database
  ...
  //   fetchNotifications();
  //   const interval = setInterval(fetchNotifications, 5000); // Polling tiap 5 detik
      ...
      <Dropdown isOpen={isOpen} onClose={closeDropdown} className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0">
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          {notifications.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full py-8 text-center text-gray-400 dark:text-gray-500">
